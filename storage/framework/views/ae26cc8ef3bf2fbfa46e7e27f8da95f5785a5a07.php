            ...
            <div style="padding: 25px; width: 100%; max-width: 1200px; margin: auto;">
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                            ...
                            <div style="background: #f8f9fa; border-radius: 10px; padding: 15px; margin-bottom: 15px;">
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                    ...
                                    <div style="font-family: monospace; font-weight: bold; color: #ad0000;">
                                        <?php echo e(Auth::user()->student_id ?? 'Your Student ID'); ?>
                    ...
                    <div
                        ...
                        <form action="<?php echo e(route('students.payments.upload')); ?>" method="POST"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="background: white; border-bottom: 1px solid #eee;">
                                        <td style="padding: 10px;"><?php echo e($payment->created_at->format('d M Y')); ?></td>
                                        <td style="padding: 10px;">RM <?php echo e(number_format($payment->amount, 2)); ?></td>
                                        <td style="padding: 10px;">
                                            ...
                                            <?php else: ?>
                                                <span style="color: #666; font-weight: 500;"><?php echo e($payment->status); ?></span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myFYP\resources\views/students/payments.blade.php ENDPATH**/ ?>