...
<?php $__env->startSection('title', 'Warden List'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div id="main-content" style="flex-grow: 1; width: 100%; transition: margin-left 0.3s ease;">
            ...
            <div
                ...
                <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <h2 style="color: #004AAD; margin: 0;">Warden List</h2>
                </div>
            ...
            <div style="padding: 25px; width: 100%; max-width: 1200px; margin: auto;">
                <h3 style="color: #004AAD; margin-bottom: 20px;">Your Wardens</h3>

                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px;">
                    <?php $__currentLoopData = $wardens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warden): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="warden-card"
                            style="background: white; padding: 20px; border-radius: 20px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); text-align: center; transition: transform 0.2s, box-shadow 0.2s;">
                            <!-- Updated profile picture line -->
                            <img src="<?php echo e($warden->profile_picture ? asset('storage/' . $warden->profile_picture) : asset('images/admin-avatar.png')); ?>"
                                alt="Warden Photo"
                                style="width:100px; height:100px; border-radius:50%; object-fit:cover; margin-bottom:10px; border: 3px solid #004AAD;">
                            <h4 style="color: #004AAD; margin:5px 0;"><?php echo e($warden->name); ?></h4>
                            <p style="font-size:14px; color:#555; margin:3px 0;">📧 <?php echo e($warden->email); ?></p>
                            <!-- Updated phone number - check if phone_number exists in users table -->
                            <p style="font-size:14px; color:#555; margin:3px 0;">📞
                                <?php echo e($warden->phone_number ?? 'Not provided'); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <?php if($wardens->isEmpty()): ?>
                        <p style="grid-column: 1 / -1; text-align:center; color:#555;">No wardens found.</p>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Hover animation for warden cards
            document.querySelectorAll('.warden-card').forEach(card => {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myFYP\resources\views/students/wardens.blade.php ENDPATH**/ ?>