...
<?php $__env->startSection('content'); ?>
        ...
        <div id="main-content" style="flex-grow: 1; width: 100%; transition: margin-left 0.3s ease;">
            ...
            <div id="profile-card"
                ...
                <div style="margin-bottom: 25px;">
                    <img src="<?php echo e($user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('images/student-avatar.png')); ?>"
                        style="width: 150px; height: 150px; border-radius: 50%; border: 4px solid #004AAD; object-fit: cover; margin: 0 auto 20px;">
                </div>

                <!-- Student Information -->
                <div style="margin-bottom: 30px;">
                    <h2 style="color: #004AAD; margin-bottom: 25px; font-size: 24px;"><?php echo e($student->name ?? 'N/A'); ?></h2>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span style="color: #666; text-align: right; flex: 1;"><?php echo e($student->student_id ?? '-'); ?></span>
                        </div>
                        <div
                            style="display: flex; justify-content: space-between; border-bottom: 1px solid #eee; padding-bottom: 8px;">
                            <strong style="color: #333; min-width: 120px;">Room Number:</strong>
                            <span
                                style="color: #666; text-align: right; flex: 1;"><?php echo e($student->hostel_room ?? '-'); ?></span>
                        </div>
                        <div
                            style="display: flex; justify-content: space-between; border-bottom: 1px solid #eee; padding-bottom: 8px;">
                            <strong style="color: #333; min-width: 120px;">Course:</strong>
                            <span style="color: #666; text-align: right; flex: 1;"><?php echo e($student->course ?? '-'); ?></span>
                        </div>
                        <div
                            style="display: flex; justify-content: space-between; border-bottom: 1px solid #eee; padding-bottom: 8px;">
                            <strong style="color: #333; min-width: 120px;">Phone Number:</strong>
                            <span
                                style="color: #666; text-align: right; flex: 1;"><?php echo e($student->phone_number ?? '-'); ?></span>
                        </div>
                        <div
                            style="display: flex; justify-content: space-between; border-bottom: 1px solid #eee; padding-bottom: 8px;">
                            <strong style="color: #333; min-width: 120px;">Email:</strong>
                            <span style="color: #666; text-align: right; flex: 1;"><?php echo e($user->email ?? '-'); ?></span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <strong style="color: #333; min-width: 120px;">Address:</strong>
                            <span
                                style="color: #666; text-align: right; flex: 1; line-height: 1.4;"><?php echo e($student->address ?? '-'); ?></span>
                        </div>
                    </div>
                </div>
    ...
    <div id="edit-profile-modal"
        ...
        <div
            ...
            <form action="<?php echo e(route('students.profile.update')); ?>" method="POST" enctype="multipart/form-data"
                id="profile-form">
                <?php echo csrf_field(); ?>
                ...
                <div style="text-align: center; margin-bottom: 25px;">
                    <img id="profile-preview"
                        src="<?php echo e($user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('images/student-avatar.png')); ?>"
                ...
                <div style="display: flex; flex-direction: column; gap: 15px; margin-bottom: 20px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="student_id"
                            value="<?php echo e(old('student_id', $student->student_id ?? '')); ?>" required
                            style="width:100%; padding:12px; border-radius:8px; border:1px solid #ddd; font-size: 14px;">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="course" value="<?php echo e(old('course', $student->course ?? '')); ?>"
                            required
                            style="width:100%; padding:12px; border-radius:8px; border:1px solid #ddd; font-size: 14px;">
                    </div>
                        ...
                        <select name="hostel_room"
                            ...
                            <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($room->room_number); ?>"
                                    <?php echo e(old('hostel_room', $student->hostel_room) == $room->room_number ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <textarea name="address" placeholder="Enter your address"
                            style="width:100%; padding:12px; border-radius:8px; border:1px solid #ddd; font-size: 14px; resize: vertical; min-height: 80px;"><?php echo e(old('address', $student->address ?? '')); ?></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myFYP\resources\views/students/profile.blade.php ENDPATH**/ ?>