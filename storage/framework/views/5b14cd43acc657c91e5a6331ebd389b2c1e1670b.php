...
<?php $__env->startSection('title', 'Student Rules'); ?>
    ...
    <div class="student-dashboard"
        ...
        <div id="main-content" style="flex-grow: 1; width: 100%; transition: margin-left 0.3s ease;">
            ...
            <div style="padding: 25px; width: 100%; max-width: 800px; margin: auto;">
                ...
                <?php if(isset($rules) && $rules->count() > 0): ?>
                    <div class="accordion">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myFYP\resources\views/students/rules.blade.php ENDPATH**/ ?>