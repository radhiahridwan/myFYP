            ...
            <div style="padding: 25px; width: 100%; max-width: 1400px; margin: auto;">
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 30px; flex-wrap: wrap;">
                    <div
                        ...
                        <p style="font-size: 24px; font-weight: bold;"><?php echo e($totalStudents); ?></p>
                    </div>
                    <div
                        ...
                        <h3>Total Paid</h3>
                        <p style="font-size: 24px; font-weight: bold;"><?php echo e($totalPaid); ?></p>
                    </div>
                    <div
                        ...
                        <h3>Total Pending</h3>
                        <p style="font-size: 24px; font-weight: bold;"><?php echo e($totalPending); ?></p>
                    </div>
                    <div
                        ...
                        <p style="font-size: 24px; font-weight: bold;">
                            <?php echo e($payments->where('status', 'rejected')->count()); ?>
                ...
                <div
                    ...
                    <div style="margin-bottom: 20px;">
                        <form method="GET" action="<?php echo e(route('admin.payments')); ?>"
                    ...
                    <table style="width: 100%; border-collapse: collapse; text-align:left; min-width: 800px;">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr style="border-bottom: 1px solid #eee;">
                                    <td style="padding: 12px;">
                                        <?php echo e($payment->user->student->name ?? 'N/A'); ?>

                                    </td>
                                    <td style="padding: 12px; font-weight: 500;">
                                        <?php echo e($payment->user->student->student_id ?? 'N/A'); ?>
                        ...
                        font-size: 12px;
                        font-weight: 500;
                        <?php if($payment->status == 'pending'): ?> background: #fff3cd; color: #856404; border: 1px solid #ffeaa7;
                        <?php elseif($payment->status == 'paid'): ?> 
                            background: #d1edff; color: #005503; border: 1px solid #62ea6b;
                        <?php elseif($payment->status == 'rejected'): ?> 
                            background: #f8d7da; color: #721c24; border: 1px solid #f5c6cb; <?php endif; ?>
                    ">
                                            <?php echo e(ucfirst($payment->status)); ?>

                                        </span>
                                    </td>
                                    <td style="padding: 12px;"><?php echo e($payment->created_at->format('d/m/Y H:i')); ?></td>
                                    <td style="padding: 12px;">
                                        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                                            <!-- View Receipt Button -->
                                            <?php if($payment->receipt): ?>
                                                <a href="<?php echo e(route('admin.payments.receipt', $payment->id)); ?>"
                                                    target="_blank"
                                                    style="background: #004AAD; color: white; padding: 6px 12px; border-radius: 6px; text-decoration: none; font-size: 12px;">
                                                    View Receipt
                                                </a>
                                                <a href="<?php echo e(route('admin.payments.download', $payment->id)); ?>"
                                            ...
                                            <form method="POST"
                                                ...
                                                <select name="status" onchange="this.form.submit()"
                                                    ...
                                                    <option value="pending"
                                                        <?php echo e($payment->status == 'pending' ? 'selected' : ''); ?>>Pending
                                                    </option>
                                                    <option value="paid"
                                                        <?php echo e($payment->status == 'paid' ? 'selected' : ''); ?>>Paid</option>
                                                    <option value="rejected"
                                                        <?php echo e($payment->status == 'rejected' ? 'selected' : ''); ?>>Rejected
                                                    </option>
                                                </select>
                                            </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myFYP\resources\views/admin/payments.blade.php ENDPATH**/ ?>