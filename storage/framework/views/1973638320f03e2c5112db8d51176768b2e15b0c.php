        ...
        <div id="main-content" style="flex-grow: 1; width: 100%; transition: margin-left 0.3s ease;">
            ...
            <div style="padding: 25px; width: 100%; max-width: 600px; margin: auto;">
                ...
                <div style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                    ...
                    <form method="POST" action="<?php echo e(route('students.settings.update-password')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <div style="position: relative;">
                                ...
                                <span id="toggleNewPassword"
                                    ...
                                    <img src="<?php echo e(asset('images/eye-close.png')); ?>" alt="Show Password"
                        ...
                        <?php if(session('success')): ?>
                            <div id="success-message"
                                ...
                                <strong><?php echo e(session('success')['message']); ?></strong>
                                <?php if(isset(session('success')['new_password'])): ?>
                                    <div style="margin-top: 10px;">
                                        ...
                                        <span
                                            ...
                                            <?php echo e(session('success')['new_password']); ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            toggleNewPassword.addEventListener('click', function() {
                if (newPasswordInput.type === 'password') {
                    ...
                    newPasswordEyeIcon.src = "<?php echo e(asset('images/eye-open.png')); ?>";
                } else {
                    newPasswordInput.type = 'password';
                    newPasswordEyeIcon.src = "<?php echo e(asset('images/eye-close.png')); ?>";
                }
            });
            ...
            toggleConfirmPassword.addEventListener('click', function() {
                if (confirmPasswordInput.type === 'password') {
                    ...
                    confirmPasswordEyeIcon.src = "<?php echo e(asset('images/eye-open.png')); ?>";
                } else {
                    confirmPasswordInput.type = 'password';
                    confirmPasswordEyeIcon.src = "<?php echo e(asset('images/eye-close.png')); ?>";
                }
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myFYP\resources\views/students/setting.blade.php ENDPATH**/ ?>