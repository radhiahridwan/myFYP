...
<?php $__env->startSection('title', 'Vehicle Sticker Application'); ?>
    ...
    <div class="student-dashboard"
        ...
        <div id="main-content" style="flex-grow: 1; width: 100%; transition: margin-left 0.3s ease;">
            ...
            <div style="padding: 25px; max-width: 800px; margin: 0 auto;">
                ...
                <!-- Application Form -->
                <form action="<?php echo e(route('forms.vehicle-sticker.store')); ?>" method="POST" enctype="multipart/form-data"
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            ...
                            <div>
                                <label style="display: block; font-weight: 500; color: #333; margin-bottom: 8px;">Full
                                    Name</label>
                                <input type="text"
                                    value="<?php echo e(Auth::user()->student->name ?? (Auth::user()->name ?? 'N/A')); ?>" readonly
                            ...
                            <div>
                                <label style="display: block; font-weight: 500; color: #333; margin-bottom: 8px;">Student
                                    ID</label>
                                <input type="text" value="<?php echo e(Auth::user()->student->student_id ?? 'N/A'); ?>" readonly
                                    style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 6px; background: #f8f9fa; color: #666;">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone"
                                    value="<?php echo e(Auth::user()->student->phone_number ?? (Auth::user()->phone ?? '')); ?>"
                                    required
                            ...
                            <div>
                                <label style="display: block; font-weight: 500; color: #333; margin-bottom: 8px;">Room
                                    Number</label>
                                <input type="text" value="<?php echo e(Auth::user()->student->hostel_room ?? 'N/A'); ?>" readonly
                                    style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 6px; background: #f8f9fa; color: #666;">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myFYP\resources\views/students/vehicle-sticker.blade.php ENDPATH**/ ?>