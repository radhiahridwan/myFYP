...
<head>
    <meta charset="utf-8">
    <title>Student List - {{ date('Y-m-d') }}</title>
    <style>
        body {
...
<body>
    ...
    @if (count($students) > 0)
            ...
            <tbody>
                @foreach ($students as $index => $student)
                    <tr>
                        ...
                        <td>{{ $student->hostel_room ?? 'Not Assigned' }}</td>
                        <td class="address-cell">{{ $student->address ?? 'N/A' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="summary">
            ...
            <p><strong>Assigned to Rooms:</strong> {{ $students->where('hostel_room', '!=', null)->count() }}</p>
            <p><strong>Unassigned Students:</strong> {{ $students->where('hostel_room', null)->count() }}</p>
        </div>
    @else
        <div class="no-data">
