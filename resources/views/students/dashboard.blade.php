        ...
        <div id="main-content" style="flex-grow: 1; width: 100%; transition: margin-left 0.3s ease;">
            ...
            <div style="padding: 25px; width: 100%; max-width: 1200px; margin: auto;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px;">
                    ...
                    @endphp
                    @foreach ($tabs as $tab)
                        <a href="{{ $tab['url'] }}" style="text-decoration:none; color:inherit;">
                            <div class="dashboard-card"
                                ...
                                <img src="{{ asset('images/' . $tab['icon']) }}" alt="{{ $tab['title'] }}"
                                    style="width: 50px; height: 50px; object-fit: contain; margin-bottom: 10px;">
                                <h4 style="color: #004AAD; margin: 10px 0 5px;">{{ $tab['title'] }}</h4>
                                <p style="font-size: 14px; color: #555;">{{ $tab['desc'] }}</p>
                            </div>
                        </a>
                    @endforeach
                </div>
