...
$checkOutStatus = $checkOutForm->status ?? 'not_applied';
                        ...
                        ">
                            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                    ...
                                    @if ($hasVehicleSticker)
                                        ...
                                        <div
                                            ...
                                            <div style="font-size: 12px; color: #666;">
                                                ...
                                                {{ $vehicleForm->created_at->format('d M Y') }}<br>
                                                <strong>Vehicle:</strong>
                                                {{ $vehicleData['registration_number'] ?? 'N/A' }} -
                                                {{ $vehicleData['model_color'] ?? 'N/A' }}
                                            </div>
                                        </div>

                                        <!-- Comments Section -->
                                        @if ($vehicleForm->admin_comment)
                                            <div style="margin-top: 15px;">
                                                <h4 style="color: #004AAD; margin: 0 0 10px 0; font-size: 14px;">Comments &
                                                    Updates</h4>
                                                <button onclick="toggleComments('vehicle-{{ $vehicleForm->id }}')"
                                                ...
                                                <div id="vehicle-{{ $vehicleForm->id }}-comments" style="display: none;">
                                                    <!-- Admin Comments -->
                                                    <div
                                                        ...
                                                        <div style="font-size: 12px; color: #856404;">
                                                            ...
                                                            <span style="color: #666; font-size: 11px;">
                                                                {{ $vehicleForm->updated_at->format('M j, Y g:i A') }}
                                                            </span>
                                                        </div>
                                                        <div
                                                            style="font-size: 13px; color: #333; margin-top: 5px; white-space: pre-line;">
                                                            {{ $vehicleForm->admin_comment }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 10px;">
                                    <a href="{{ route('forms.vehicle-sticker.create') }}"
                                        ...
                                        {{ $hasVehicleSticker ? 'Apply Again' : 'Click to Apply' }}
                                    </a>
                                    <div style="text-align: right;">
                                        ...
                                        @if ($hasVehicleSticker)
                                            ...
                                            @endphp
                                            <span
                                                style="background: {{ $color['bg'] }}; color: {{ $color['text'] }}; padding: 4px 10px; border-radius: 12px; font-size: 11px; font-weight: bold;">
                                                {{ $color['label'] }}
                                            </span>
                                        @else
                                            <span
                        ...
                        ">
                            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                <div style="flex: 1;">
                                    ...
                                    @if ($hasFacilityReport)
                                        ...
                                        <div
                                            ...
                                            <div style="font-size: 12px; color: #666;">
                                                <strong>Submitted:</strong>
                                                {{ $facilityForm->created_at->format('d M Y') }}
                                            </div>
                                        </div>

                                        <!-- Comments Section -->
                                        @if ($facilityForm->admin_comment)
                                            <div style="margin-top: 15px;">
                                                <h4 style="color: #004AAD; margin: 0 0 10px 0; font-size: 14px;">Comments &
                                                    Updates</h4>
                                                <button onclick="toggleComments('facility-{{ $facilityForm->id }}')"
                                                    style="background: #004AAD; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-size: 11px; margin-bottom: 10px;">
                                                    Show Comments
                                                </button>
                                                <div id="facility-{{ $facilityForm->id }}-comments"
                                                    style="display: none;">
                                                    <!-- Admin Comments -->
                                                    <div
                                                        style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 6px; padding: 10px; margin-bottom: 10px;">
                                                        <div style="font-size: 12px; color: #856404;">
                                                            <strong>Admin:</strong>
                                                            <span style="color: #666; font-size: 11px;">
                                                                {{ $facilityForm->updated_at->format('M j, Y g:i A') }}
                                                            </span>
                                                        </div>
                                                        <div
                                                            style="font-size: 13px; color: #333; margin-top: 5px; white-space: pre-line;">
                                                            {{ $facilityForm->admin_comment }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 10px;">
                                    <a href="{{ route('forms.facility-report.create') }}"
                                        style="background: #004AAD; color: white; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 13px; transition: background 0.3s; white-space: nowrap;">
                                        {{ $hasFacilityReport ? 'Report Again' : 'Click to Apply' }}
                                    </a>
                                    <div style="text-align: right;">
                                        <div style="font-size: 13px; color: #333; margin-bottom: 3px;">Status:</div>
                                        @if ($hasFacilityReport)
                        ...
                        ">
                            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                <div style="flex: 1;">
                                    ...
                                    @if ($hasChangeRoom)
                                        ...
                                        <div
                                            ...
                                            <div style="font-size: 12px; color: #666;">
                                                <strong>Submitted:</strong>
                                                {{ $changeRoomForm->created_at->format('d M Y') }}
                                            </div>
                                        </div>

                                        <!-- Comments Section -->
                                        @if ($changeRoomForm->admin_comment)
                                            <div style="margin-top: 15px;">
                                                <h4 style="color: #004AAD; margin: 0 0 10px 0; font-size: 14px;">Comments &
                                                    Updates</h4>
                                                <button onclick="toggleComments('change-room-{{ $changeRoomForm->id }}')"
                                                    style="background: #004AAD; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-size: 11px; margin-bottom: 10px;">
                                                    Show Comments
                                                </button>
                                                <div id="change-room-{{ $changeRoomForm->id }}-comments"
                                                    style="display: none;">
                                                    <!-- Admin Comments -->
                                                    <div
                                                        style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 6px; padding: 10px; margin-bottom: 10px;">
                                                        <div style="font-size: 12px; color: #856404;">
                                                            <strong>Admin:</strong>
                                                            <span style="color: #666; font-size: 11px;">
                                                                {{ $changeRoomForm->updated_at->format('M j, Y g:i A') }}
                                                            </span>
                                                        </div>
                                                        <div
                                                            style="font-size: 13px; color: #333; margin-top: 5px; white-space: pre-line;">
                                                            {{ $changeRoomForm->admin_comment }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 10px;">
                                    <a href="{{ route('forms.change-room.create') }}"
                                        style="background: #004AAD; color: white; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 13px; transition: background 0.3s; white-space: nowrap;">
                                        {{ $hasChangeRoom ? 'Request Again' : 'Click to Apply' }}
                                    </a>
                                    <div style="text-align: right;">
                                        <div style="font-size: 13px; color: #333; margin-bottom: 3px;">Status:</div>
                                        @if ($hasChangeRoom)
                        ...
                        ">
                            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                <div style="flex: 1;">
                                    ...
                                    @if ($hasCheckOut)
                                        ...
                                        <div
                                            ...
                                            <div style="font-size: 12px; color: #666;">
                                                <strong>Submitted:</strong>
                                                {{ $checkOutForm->created_at->format('d M Y') }}
                                            </div>
                                        </div>

                                        <!-- Comments Section -->
                                        @if ($checkOutForm->admin_comment)
                                            <div style="margin-top: 15px;">
                                                <h4 style="color: #004AAD; margin: 0 0 10px 0; font-size: 14px;">Comments &
                                                    Updates</h4>
                                                <button onclick="toggleComments('checkout-{{ $checkOutForm->id }}')"
                                                    style="background: #004AAD; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-size: 11px; margin-bottom: 10px;">
                                                    Show Comments
                                                </button>
                                                <div id="checkout-{{ $checkOutForm->id }}-comments"
                                                    style="display: none;">
                                                    <!-- Admin Comments -->
                                                    <div
                                                        style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 6px; padding: 10px; margin-bottom: 10px;">
                                                        <div style="font-size: 12px; color: #856404;">
                                                            <strong>Admin:</strong>
                                                            <span style="color: #666; font-size: 11px;">
                                                                {{ $checkOutForm->updated_at->format('M j, Y g:i A') }}
                                                            </span>
                                                        </div>
                                                        <div
                                                            style="font-size: 13px; color: #333; margin-top: 5px; white-space: pre-line;">
                                                            {{ $checkOutForm->admin_comment }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 10px;">
                                    <a href="{{ route('forms.check-out.create') }}"
                                        style="background: #004AAD; color: white; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 13px; transition: background 0.3s; white-space: nowrap;">
                                        {{ $hasCheckOut ? 'View Application' : 'Click to Apply' }}
                                    </a>
                                    <div style="text-align: right;">
                                        <div style="font-size: 13px; color: #333; margin-bottom: 3px;">Status:</div>
                                        @if ($hasCheckOut)
