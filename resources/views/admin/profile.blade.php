        ...
        <div id="main-content" style="flex-grow: 1; width: 100%; transition: margin-left 0.3s ease;">
            ...
            <div id="profile-card"
                ...
                <div style="margin-bottom: 25px;">
                    <img src="{{ $admin->profile_picture ? asset('storage/' . $admin->profile_picture) : asset('images/admin-avatar.png') }}"
                        style="width: 150px; height: 150px; border-radius: 50%; border: 4px solid #004AAD; object-fit: cover; margin: 0 auto 20px;">
                </div>

                <!-- Admin Information -->
                <div style="margin-bottom: 30px;">
                    <h2 style="color: #004AAD; margin-bottom: 25px; font-size: 24px;">{{ $admin->name ?? 'N/A' }}</h2>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span style="color: #666; text-align: right; flex: 1;">{{ $admin->email ?? '-' }}</span>
                        </div>
                        <div
                            style="display: flex; justify-content: space-between; border-bottom: 1px solid #eee; padding-bottom: 8px;">
                            <strong style="color: #333; min-width: 120px;">Phone Number:</strong>
                            <span
                                style="color: #666; text-align: right; flex: 1;">{{ $adminWithUser->phone_number ?? '-' }}</span>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data"
                ...
                <div style="text-align: center; margin-bottom: 25px;">
                    <img id="profile-preview"
                        src="{{ $admin->profile_picture ? asset('storage/' . $admin->profile_picture) : asset('images/admin-avatar.png') }}"
                ...
                <div style="display: flex; flex-direction: column; gap: 15px; margin-bottom: 20px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_number"
                            value="{{ old('phone_number', $adminWithUser->phone_number ?? '') }}"
                            style="width:100%; padding:12px; border-radius:8px; border:1px solid #ddd; font-size: 14px;">
                    </div>
                </div>
