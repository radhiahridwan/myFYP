                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                    ...
                                    <div>
                                        ...
                                        @endphp
                                        <span
                                            style="background: {{ $color['bg'] }}; color: {{ $color['text'] }}; padding: 8px 16px; border-radius: 6px; font-size: 14px; font-weight: bold; display: inline-block;">
                                            {{ str_replace('_', ' ', ucfirst($form->status)) }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                    ...
                                    <div>
                                        ...
                                        <div
                                            style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                            {{ $form->user->student->phone_number ?? ($formDataArray['phone'] ?? 'N/A') }}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div
                                            style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                            {{ $form->user->student->hostel_room ?? 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                {{ ucfirst($formDataArray['vehicle_type'] ?? 'N/A') }}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                {{ $formDataArray['registration_number'] ?? 'N/A' }}
                                            </div>
                                        </div>
                            ...
                            @if ($form->type == 'facility_report')
                                <div
                                    ...
                                    <!-- Room Inventory -->
                                    @if (isset($formDataArray['inventory']))
                                        <div style="margin-bottom: 25px;">
                                            <h4 style="color: #004AAD; margin-bottom: 15px;">Room Inventory Count</h4>
                                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                                @foreach (['kerusi' => 'Chair (Kerusi)', 'meja' => 'Table (Meja)', 'almari' => 'Wardrobe (Almari)', 'katil' => 'Bed (Katil)', 'tilam' => 'Mattress (Tilam)'] as $key => $label)
                                                    <div style="padding: 10px; background: #f8f9fa; border-radius: 6px;">
                                                        <strong>{{ $label }}</strong><br>
                                                        <span
                                                            style="color: #666;">{{ $formDataArray['inventory'][$key] ?? 0 }}/10</span>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    <!-- Condition Checklist -->
                                    @if (isset($formDataArray['condition']))
                                        <div style="margin-bottom: 25px;">
                                            ...
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                                    @foreach (['lampu' => 'Light', 'kipas' => 'Fan', 'plug_socket' => 'Plug Socket'] as $key => $label)
                                                        @if (isset($formDataArray['condition'][$key]))
                                                            <div
                                                                style="padding: 8px; background: #f8f9fa; border-radius: 4px;">
                                                                <strong>{{ $label }}:</strong>
                                                                <span
                                                                    style="color: #666; text-transform: capitalize;">{{ str_replace('_', ' ', $formDataArray['condition'][$key]) }}</span>
                                                            </div>
                                                        @endif
                                                    @endforeach
                                                </div>
                                            ...
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                                    @foreach (['toilet' => 'Toilet', 'shower' => 'Shower', 'sink' => 'Sink'] as $key => $label)
                                                        @if (isset($formDataArray['condition'][$key]))
                                                            <div
                                                                style="padding: 8px; background: #f8f9fa; border-radius: 4px;">
                                                                <strong>{{ $label }}:</strong>
                                            ...
                                            <div>
                                                ...
                                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                                    @foreach (['langsir' => 'Curtain', 'pintu' => 'Door', 'tingkap' => 'Window'] as $key => $label)
                                                        @if (isset($formDataArray['condition'][$key]))
                                                            <div
                                                                style="padding: 8px; background: #f8f9fa; border-radius: 4px;">
                                                                <strong>{{ $label }}:</strong>
                                    ...
                                    <!-- Damage Description -->
                                    @if (isset($formDataArray['damage_description']))
                                        <div style="margin-bottom: 25px;">
                                            ...
                                            <div
                                                ...
                                                {{ $formDataArray['damage_description'] }}
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                {{ $formDataArray['current_room'] ?? 'N/A' }}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                {{ $formDataArray['preferred_room'] ?? 'N/A' }}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div
                                                ...
                                                {{ str_replace('_', ' ', $formDataArray['reason'] ?? 'N/A') }}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                {{ $formDataArray['preferred_date'] ? date('F j, Y', strtotime($formDataArray['preferred_date'])) : 'Not specified' }}
                                            </div>
                                        </div>
                                        ...
                                        <div style="grid-column: span 2;">
                                            ...
                                            <div
                                                ...
                                                {{ $formDataArray['explanation'] ?? 'No explanation provided' }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                        ...
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                {{ $formDataArray['checkout_date'] ? date('F j, Y', strtotime($formDataArray['checkout_date'])) : 'Not specified' }}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div
                                                ...
                                                @endphp
                                                {{ $reasonLabels[$formDataArray['reason']] ?? ucfirst($formDataArray['reason'] ?? 'N/A') }}
                                            </div>
                                        </div>
                                        ...
                                        <div style="grid-column: span 2;">
                                            ...
                                            <div
                                                style="padding: 15px; background: #f8f9fa; border-radius: 6px; color: #666; white-space: pre-line;">
                                                {{ $formDataArray['forwarding_address'] ?? 'No address provided' }}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                {{ $formDataArray['emergency_contact_name'] ?? 'N/A' }}<br>
                                                {{ $formDataArray['emergency_contact_phone'] ?? 'N/A' }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <div
                                                style="padding: 10px 12px; background: #f8f9fa; border-radius: 6px; color: #666;">
                                                <a href="/admin/payments?student={{ $form->user->student->student_id ?? '' }}"
                            ...
                            <div
                                ...
                                <div style="display: grid; grid-template-columns: 1fr; gap: 15px;">
                                    ...
                                    @if ($form->type == 'vehicle_sticker')
                                        @if (isset($formDataArray['drivers_license']) && $formDataArray['drivers_license'])
                                            <div
                                                ...
                                                <div style="font-size: 14px; color: #666;">
                                                    {{ basename($formDataArray['drivers_license']) }}</div>
                                                <a href="{{ asset('storage/' . $formDataArray['drivers_license']) }}"
                                                    target="_blank"
                                        ...
                                        @if (isset($formDataArray['vehicle_registration']) && $formDataArray['vehicle_registration'])
                                            <div
                                                style="padding: 15px; background: #f8fbff; border-radius: 6px; border-left: 4px solid #004AAD;">
                                                <div style="font-weight: 500; color: #333; margin-bottom: 5px;">Vehicle
                                                    Registration</div>
                                                <div style="font-size: 14px; color: #666;">
                                                    {{ basename($formDataArray['vehicle_registration']) }}</div>
                                                <a href="{{ asset('storage/' . $formDataArray['vehicle_registration']) }}"
                                                    target="_blank"
                                                    style="background: #004AAD; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 12px; margin-top: 8px; text-decoration: none; display: inline-block;">
                                                    View Document
                                                </a>
                                        ...
                                        @if (isset($formDataArray['insurance_document']) && $formDataArray['insurance_document'])
                                            <div
                                                style="padding: 15px; background: #f8fbff; border-radius: 6px; border-left: 4px solid #004AAD;">
                                                <div style="font-weight: 500; color: #333; margin-bottom: 5px;">Insurance
                                                    Document</div>
                                                <div style="font-size: 14px; color: #666;">
                                                    {{ basename($formDataArray['insurance_document']) }}</div>
                                                <a href="{{ asset('storage/' . $formDataArray['insurance_document']) }}"
                                                    target="_blank"
                                                    style="background: #004AAD; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 12px; margin-top: 8px; text-decoration: none; display: inline-block;">
                                                    View Document
                                                </a>
                                    ...
                                    @if ($form->type == 'facility_report' && isset($formDataArray['media']) && count($formDataArray['media']) > 0)
                                        @foreach ($formDataArray['media'] as $media)
                                            <div
                                                style="padding: 15px; background: #f8fbff; border-radius: 6px; border-left: 4px solid #004AAD;">
                                                <div style="font-weight: 500; color: #333; margin-bottom: 5px;">
                                                    @if (str_contains($media, '.jpg') ||
                                                            str_contains($media, '.jpeg') ||
                                                            str_contains($media, '.png') ||
                                                            str_contains($media, '.gif'))
                                                        Photo
                                                    @elseif(str_contains($media, '.mp4') || str_contains($media, '.mov') || str_contains($media, '.avi'))
                                                        Video
                                                    @else
                                                        File
                                                    @endif
                                                </div>
                                                <div style="font-size: 14px; color: #666;">{{ basename($media) }}</div>
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div style="margin-bottom: 15px;">
                                    ...
                                    <textarea id="adminComment"
                                        ...
                                        placeholder="Add a comment for the student...">{{ $form->admin_comment }}</textarea>
                                </div>

                                <button onclick="updateFormStatus({{ $form->id }})"
                            ...
                            <div
                                ...
                                <div style="display: grid; grid-template-columns: 1fr; gap: 10px; margin-bottom: 20px;">
                                    <button onclick="updateStatusDirect({{ $form->id }}, 'approved')"
                                    ...
                                    <button onclick="updateStatusDirect({{ $form->id }}, 'rejected')"
                                    ...
                                    <button onclick="updateStatusDirect({{ $form->id }}, 'completed')"
                                ...
                                <div style="border-top: 2px solid #f0f0f0; padding-top: 20px;">
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 10px;">
                                        <button onclick="exportToPDF({{ $form->id }})"
